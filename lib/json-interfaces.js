...
JsonInterfaces.elements.ScalarElement = (function(_super) {
  ...
  ScalarElement.prototype.getElName = function() {
    return this.options.name;
  };

  ScalarElement.prototype.getElId = function() {
    return this.options.id || this.getElName();
  };
  ...
  Factory.processCondition = function(condition) {
    ...
    if ($.isPlainObject(condition)) {
      for (name in condition) {
        ...
        return (function(value, parentElement, done) {
          return done(parentElement.getElement(name).get() === checkValue);
        });
      }
    }
    return false;
...
JsonInterfaces.elements.Date = (function(_super) {
  ...
  function Date(options) {
    ...
    Date.__super__.constructor.call(this, options);
  }
...
JsonInterfaces.layouts.OneColumnLayout = (function() {
  ...
  OneColumnLayout.prototype.render = function($el) {
    ...
    return $("form.one-column-layout", this.options.$el).on("submit", (function(_this) {
      return function(e) {
        e.preventDefault();
