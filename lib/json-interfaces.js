...
JsonInterfaces.elements.ScalarElement = (function(_super) {
  ...
  ScalarElement.prototype.normalizeValueForSet = function(keypath, value) {
    ...
    if (keypath && 'undefined' === !typeof value) {
      obj = {};
      obj[keypath] = value;
      return obj;
    }
...
JsonInterfaces.templates.password = '<div rv-show="element.show" class="form-group"><label rv-for="options.name" data-show="options.label">{options.label}</label><p data-show="options.help" rv-html="options.help" class="help-block"></p><input type="password" rv-name="element#getElName" rv-id="element#getElId" rv-value="element:value" class="form-control"/><div class="error-wrapper"><div rv-each-error="element.errors" class="error alert alert-danger shake animated">{error}</div></div></div>';

JsonInterfaces.templates.radio = '<div rv-show="element.show" class="form-group"><label rv-for="options.name" data-show="options.label">{options.label}</label><p data-show="options.help" rv-html="options.help" class="help-block"></p><label rv-each-option="options.options" class="radio-inline"><input type="radio" rv-name="element#getElName" rv-value="option.value" rv-checked="element:value"/><span>{option.label}</span></label><div class="error-wrapper"><div rv-each-error="element.errors" class="error alert alert-danger shake animated">{error}</div></div></div>';

JsonInterfaces.templates.select = '<div rv-show="element.show" class="form-group"><label rv-for="options.name" data-show="options.label">{options.label}</label><p data-show="options.help" rv-html="options.help" class="help-block"></p><select rv-name="element#getElName" rv-id="element#getElId" rv-value="element:value" class="form-control"><option rv-each-option="options.options" rv-value="option.value">{option.label}</option></select><div class="error-wrapper"><div rv-each-error="element.errors" class="error alert alert-danger shake animated">{error}</div></div></div>';
...
JsonInterfaces.templates.textarea = '<div rv-show="element.show" class="form-group"><label rv-for="options.name" data-show="options.label">{options.label}</label><p data-show="options.help" rv-html="options.help" class="help-block"></p><textarea rv-name="element#getElName" rv-id="element#getElId" rv-value="element:value" class="form-control"></textarea><div class="error-wrapper"><div rv-each-error="element.errors" class="error alert alert-danger shake animated">{error}</div></div></div>';

JsonInterfaces.templates.textfield = '<div rv-show="element.show" class="form-group"><label rv-for="options.name" data-show="options.label">{options.label}</label><p data-show="options.help" rv-html="options.help" class="help-block"></p><input type="text" rv-name="element#getElName" rv-id="element#getElId" rv-value="element:value" class="form-control"/><div class="error-wrapper"><div rv-each-error="element.errors" class="error alert alert-danger shake animated">{error}</div></div></div>';
      ...
      for (name in condition) {
        ...
        return (function(value, parentElement, done) {
          ...
          if (element) {
            ...
            return done(parentElement.value[name] === checkValue);
          }
        });
      }
    }
...
JsonInterfaces.elements.Email = (function(_super) {
  ...
  Email.prototype.afterRender = function() {
    Email.__super__.afterRender.apply(this, arguments);
    this.options.$el.addClass(this.options.classes);
    if (this.options.instantChange) {
      return this.input().on('keyup', (function(_this) {
        return function(e) {
...
JsonInterfaces.elements.Html = (function(_super) {
  ...
  Html.prototype.render = function($el) {
    ...
    template = "<div rv-show='element.show'>" + this.options.html + "</div>";
    this.options.$el.html(template);
  ...
  Html.prototype.afterRender = function() {
    if (!this.options.parentElement) {
      return this.conditionMet();
    }
  };

  Html.prototype.bindRivets = function() {
    return this.view = rivets.bind(this.options.$el, {
      options: this.options,
      element: this
    }, this.options.rivets || {});
