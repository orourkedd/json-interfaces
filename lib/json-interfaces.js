...
JsonInterfaces.elements.CollectionElement = (function(_super) {
  ...
  CollectionElement.prototype.set = function(keypath, value, options) {
    ...
    if (typeof value !== "undefined") {
      return this.setKeyPath(keypath, value);
    }
    value = keypath;
    ...
    for (i in _ref) {
      ...
      if (options.events) {
        $(this).trigger("change:" + i, [v, this.getElement(i)]);
      }
    }
  ...
  CollectionElement.prototype.setKeyPath = function(keypath, value) {
    var obj;
    obj = {};
    obj[keypath] = value;
    return this.set(obj);
...
JsonInterfaces.templates.address = '<div rv-show="element.show" class="address-wrapper"><div id="address-region"></div><div class="row"><div class="col-md-5"><div id="city-region"></div></div><div class="col-md-5"><div id="state-region"></div></div><div class="col-md-2"><div id="zip-region"></div></div></div></div>';
...
JsonInterfaces.elements.Address = (function(_super) {
  ...
  function Address(options) {
    ...
    options.elements = this.buildAddressElements(options.elements);
    Address.__super__.constructor.call(this, options);
  }

  Address.prototype.buildAddressElements = function(elements) {
    var options;
    if (elements == null) {
      elements = {};
    }
...
JsonInterfaces.elements.Select = (function(_super) {
  ...
  function Select(options) {
    ...
    options.options = this.processOptions(options.options, options.placeholder);
  ...
  Select.prototype.processOptions = function(options, placeholder) {
